...
struct tok_str_file_inter{
   static FILE* tok_file_;
   static FILE* sym_file_;
   static void set_tok_file(string name);
   static void set_sym_file(string name);
   static string_set set;
};
